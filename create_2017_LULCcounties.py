...
if __name__=="__main__":
    ...
    countyPath = f"{folder}/input/county_2017_10m.shp"
    county_origPath = f"{folder}/input/tl_2017_bay_county_project.shp"
    countyRasPath = f"{folder}/input/county_2017_10m.tif"
    extentRasPath = f"{folder}/input/10m_static_extent.tif"
    outputPath = f"{folder}/output/Phase7_county_2017_10m.shp"
